...
import io.github.luanrigotti.bff_agendador_tarefas.infrastructure.client.TarefasClient;
...
public class TarefasService {
    ...
    public List<TarefasDTOResponse> buscaTarefasAgendadadasPorPeriodo(LocalDateTime dataInicial,
